...
var a, b, result:real;//объявление переменных
begin
     a := StrToFloat(edit1.Text);//перевод из строки в число
     b := StrToFloat(edit2.Text);
     result := a+b;
     Label4.Caption := FloatToStr(result);//присвоение label4 результата
end;
