...
void Recruitment_agency::write_to_file_computer_LVL_HTML()
{
    ofstream out;
    out.open("computer_LVL.html", ios::app);
    for(int i = 0; i < table4.size(); i++)
    {
        out << "<tr>\n";
        out << "<th>"<< table4[i].LVL_cod << "</th>\n";
        out << "<th>"<< table4[i].LVL_name << "</th>\n";
        out << "</tr>\n";
    }
    out.close();
}
...
void Recruitment_agency::computer_LVL_menu()
{
    ...
    do
    {
        ...
        switch(x)
        {
            ...
            case 5: write_to_file_computer_LVL_HTML(); break;
            case 6: break;
