...
void Recruitment_agency::write_to_file_form(vector<form>& table3, string S3)
{
    ...
    {
        of << table3[i].form_code << " " << table3[i].form_name << endl;
    }
    of.close();
}
...
void Recruitment_agency::write_to_file_form_HTML()
{
    ofstream out;
    out.open("form.html", ios::app);
    for(int i = 0; i < table3.size(); i++)
    {
        out << "<tr>\n";
        out << "<th>"<< table3[i].form_code << "</th>\n";
        out << "<th>"<< table3[i].form_name << "</th>\n";
        out << "</tr>\n";
    }
    out.close();
}
...
void Recruitment_agency::form_menu()
{
    ...
    do
    {
        ...
        switch(x)
        {
            ...
            case 5: write_to_file_form_HTML(); break;
            case 6: break;
