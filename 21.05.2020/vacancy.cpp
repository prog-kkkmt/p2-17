...
void Recruitment_agency::write_to_file_vacancy_HTML()
{
    ofstream out;
    out.open("vacancy.html", ios::app);
    for(int i = 0; i < table5.size(); i++)
    {
        out << "<tr>\n";
        out << "<th>"<< table5[i].vacancy_cod << "</th>\n";
        out << "<th>"<< table5[i].publ_date << "</th>\n";
        out << "<th>"<< table5[i].vacancy_name << "</th>\n";
        out << "<th>"<< table5[i].salary << "</th>\n";
        out << "<th>"<< table5[i].feasibility << "</th>\n";
        out << "<th>"<< table5[i].post_cod << "</th>\n";
        out << "<th>"<< table5[i].form_cod << "</th>\n";
        out << "<th>"<< table5[i].LVL_cod << "</th>\n";
        out << "</tr>\n";
    }
    out.close();
}
...
int x = 0;
    ...
    do
    {
        ...
        switch(x)
        {
            ...
            case 5: write_to_file_vacancy_HTML(); break;
            case 6: break;
