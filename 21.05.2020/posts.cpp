...
void Recruitment_agency::write_to_file_posts_HTML()
{
    ofstream out;
        out.open("posts.html", ios::app);
        for(int i = 0; i < table.size(); i++)
        {
            out << "<tr>\n";
            out << "<th>"<< table[i].post_kod << "</th>\n";
            out << "<th>"<< table[i].post_name << "</th>\n";
            out << "</tr>\n";
        }
        out.close();
}
...
void Recruitment_agency::post_menu()
{
    ...
    do
    {
        ...
        switch(x)
        {
            ...
            case 5: write_to_file_posts_HTML(); break;
            case 6: break;
